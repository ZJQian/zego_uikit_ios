#
#  Be sure to run `pod spec lint ZegoUIKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = "ZegoUIKit SDK for iOS by ZEGO."

  spec.homepage     = "https://www.zegocloud.com"
  # spec.documentation_url = "http://doc.zego.im"
  ...
  #   # end
  # end
  spec.dependency 'ZegoExpressEngine','~>3.5.0'
